...
namespace MsRdpEx
{
    ...
    public static partial class Bindings
    {
        ...
        /// <summary>
        /// Gets the MsRdpEx instance interface implemented by a hosted RDP ActiveX control.
        /// </summary>
        public static bool TryGetRdpInstance(object? rdpClient, out IMsRdpExInstance? instance)
        {
            if (rdpClient is IMsRdpExInstance existingInstance)
            {
...
#if NET8_0_OR_GREATER
            if (rdpClient is null || !ComWrappers.TryGetComInstance(rdpClient, out nint unknown))
            {
                instance = null;
                return false;
            }
            ...
            try
            {
                Guid interfaceId = IID_IMsRdpExInstance;
                ...
                unsafe
                {
                    try
                    {
                        instance = ComInterfaceMarshaller<IMsRdpExInstance>.ConvertToManaged((void*)interfacePointer);
                        return instance is not null;
                    }
                    finally
                    {
                        ComInterfaceMarshaller<IMsRdpExInstance>.Free((void*)interfacePointer);
                    }
                }
            }
            finally
